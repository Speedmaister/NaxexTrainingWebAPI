...
namespace Naxex.WebAPI.Controllers
{
    public class ClassesController : ApiController
    {
        ...
        public IHttpActionResult PostClass(Class @class)
        {
            ...
            {
                if (ClassExists(@class.TextIIdentifier))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtRoute("DefaultApi", new { id = @class.TextIIdentifier }, @class);
        }
        ...
        {
            return db.Classes.Count(e => e.TextIIdentifier == id) > 0;
        }
    }
}